 ...
 * @LastEditTime: 2024-11-29 20:36:20
...
<template>
  <el-menu default-active="1" class="el-menu-vertical-demo" @select="handleSelect">
    ...
    <el-menu-item index="2" v-if="hasRole(['普通用户', ])">新建项目</el-menu-item>
    <el-menu-item index="3" v-if="hasRole(['普通用户', '管理员','队领导','部门安全主管','部门安全员','安全主管'])">查看项目</el-menu-item>
    <el-menu-item index="7" v-if="hasRole(['部门安全主管','部门安全员','安全主管'])">审核项目</el-menu-item>

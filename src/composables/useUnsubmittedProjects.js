 ...
 * @LastEditTime: 2024-11-18 20:08:57
...
export function useUnsubmittedProjects() {
  ...
  const addProject = async (project) => {
    try {
      ...
      await axios.post('/projectMessages/add', project);

      // Split back to array after adding
      project.internalConditions = project.internalConditions.split(',');
      console.log('before push project.internalConditions', project.internalConditions);
